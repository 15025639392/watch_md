...
建立 App 自有路线数据结构，完成 GPX 导入和路线预览。
...
2. iPhone 能收到完整轨迹点。
3. 重复 chunk 不产生重复轨迹。
4. iPhone 能识别部分同步和完整同步。
5. Watch 收到完整 ACK 前不删除本地记录。
