...
6. 华为手表具备后续验证价值，当前优先验证 WATCH 数字系列和 WATCH GT 系列；WATCH 先按完整智能表 App 验证，GT 先按长续航轻量协同验证，仍要按手机生态、系统版本、地区、机型和安装/上架路径逐项确认。
...
- [iOS 定位耗电分析、理想形态与前台注意事项](./docs/ios-location-power-analysis-v0.1.md)
